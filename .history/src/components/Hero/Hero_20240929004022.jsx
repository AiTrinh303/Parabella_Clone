  ...
  return (
    <div className='hero'>
      <div className='hero-content'>
        ...
        <h2>Parabella Analytics – die Software zur Messung, Visualisierung und Erstellung von ESG-Berichten entlang der CSRD Kriterien</h2>
        <div>
          <button className='cta'>Kostenlos testen</button>
          <button className='cta'>Mehr erfahren</button>
        </div>
