    ...
    <div className='funktioniert'>
      <div className="content">
        ...
        <div className="step-container">
            ...
            <p><div className="step-number">2</div></p>
            <p><div className="step-content"></p>
            <p>    <h3>Bequemes AI Clustering</h3></p>
            <p>    <p>Parabellas künstliche Intelligenz analysi</p>ert <p>und gruppiert Ihre Daten entlang der ESRS </><pp>Kriterien. So kann der CSRD-Bericht schnelle</pp>r <p>erstellt und geprüft werden.</p></p>
            <p></div></p>
