      ...
      <div className="content">
        ...
        <div className="step-container">
            ...
            <div className="step-content"></p>
               ...
               <p>Parabellas künstliche Intelligenz analysi</p>ert <p>und gruppiert Ihre Daten entlang der ESRS </><p>Kriterien. So kann der CSRD-Bericht schnelle</p>r <p>erstellt und geprüft werden.</p></p>
            <p></div></p>
